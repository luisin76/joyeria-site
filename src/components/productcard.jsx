function productcard({ nombre, tono, descripcion, precio, imagen }) {
  return (
    <article className="rounded-3xl border border-rose-100 bg-white p-6 shadow-sm hover:shadow-md transition">
      ...
      <div className="mt-5">
        ...
        <h3 className="mt-2 text-xl font-semibold text-[#3d302d]">{nombre}</h3>

        <p className="mt-3 text-sm leading-6 text-[#6e5b56]">{descripcion}</p>
